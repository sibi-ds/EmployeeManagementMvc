...
public interface EmployeeService {
     ...
     *
     * @return    list containing all employees and corresponding addresses
     */
    public List<String> getEmployees();

    /**
     * requests DAO to give the details of the employee and corresponding addresses
     *
    ...
    /**
     * requests DAO to give the details of the employee and corresponding projects assigned
     *
     * @param employeeId    which need to be retrieved from the database
     *
     * @return    string of employee's details
